...
static const uint8_t PROGMEM // Bitmaps are stored in program memory
  ...
  { B00100100, B00100100, B00000000, // Mouth position C
    B00101000, B00100100, B01111110,
    B00111000, B00100010, B11001001,
    B00110000, B00100010, B00011000,
    B00000000, B00100010, B00110000,
  ...
  { B00100010, B00100010, B00000000, // Mouth position D
    ...
    B00100100, B00100001, B11001001,
    B00100100, B00100001, B00011000,
    B00101000, B00100001, B00010100,
    B00110000, B00100001, B00110100,
  ...
  { B00100000, B00110000, B00100000, // Mouth position E
    ...
    B00100000, B01001000, B00100000,
    B00100000, B00101000, B00100000,
    B00100000, B00110000, B00100000 },
  { B00110000, B01001000, B00100000, // Mouth position F
    B00100000, B01001000, B00100000,
...
//  digitalWrite(13, HIGH-digitalRead(13));   // blink the led
  int input_size = 3;
  int string_length = strlen((const char*) toggle_msg.data);
  
  if(string_length == 1) {
    
    char inChar = toggle_msg.data[0];
    inputChar = inChar;
    changeFaceState();
...
ros::Subscriber<std_msgs::String> sub("face", messageCb );
